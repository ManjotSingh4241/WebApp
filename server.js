...
*
* Online (Cyclic) Link:
*https://brown-magpie-sari.cyclic.app/
********************************************************************************/
...
cloudinary.config({
    cloud_name: 'dmvhi2d7k',
    api_key: '935295252266634',
    api_secret: 'zhEM9Cd5qMcMhhBD234Imrr-GiE',
    secure: true
});
...
app.post('/register', function (req, res) {
    ...
    dataServiceAuth.registerUser(userData)
        .then(function () {
            res.render('register', { successMessage: 'home coming' });
        })
        .catch(function (err) {
